...
public class Coordinator implements User {
    ...
    public Coordinator(String adminName, String adminPassword, String pemFilename, String caClientUrl, String msp, String affiliation) {
    ...
    public void enroll() throws Exception {
        ...
        Wallet.Identity user = Wallet.Identity.createIdentity(this.msp, enrollment.getCert(), enrollment.getKey());
